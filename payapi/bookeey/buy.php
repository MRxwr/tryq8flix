...
if($isEnable){
    ...
    $bookeeyPipe->setSuccessUrl('https://payapi.createkwservers.com/bookeey/success.php');
    $bookeeyPipe->setFailureUrl('https://payapi.createkwservers.com/bookeey/failure.php');
...
function updateCheckout() {
    ...
    var url = "https://payapi.createkwservers.com/bookeey/buy.php?selectedPaymentOption="+selectedPaymentOption;
    window.location.replace(url);
}

function initiatePayment() {
    var selectedPaymentOption = getRadioVal( document.getElementById('bookeeyPaymentForm'), 'payoptions' );
    var url = "https://payapi.createkwservers.com/bookeey/buy.php?selectedPaymentOption="+selectedPaymentOption+"&initPayment=1";
    window.location.replace(url);
}
