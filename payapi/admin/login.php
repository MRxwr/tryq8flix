...
<html lang="en">
	<head>
		...
		<title>Admin Login : Create KW Payment Api</title>
		...
		<!-- vector map CSS -->
		<link href="<?php echo SITEURL; ?>admin/assets/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.css" rel="stylesheet" type="text/css"/>
		<!-- Custom CSS -->
	...
	<body>
			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						...
						<span class="brand-text">Create KW Payment Api</span>
					</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to <?php echo $lang['login_title'] ?></h3>
											<h6 class="text-center nonecase-font txt-grey">Enter your details below</h6>
										</div>	
										<div class="form-wrap">
											<form  method="post" action="">
												<div class="form-group">
													<label class="control-label mb-10" for="exampleInputEmail_2"><?php echo $lang['username'] ?></label>
													<input type="text" class="form-control" required="" id="exampleInputEmail_2" name="username" placeholder="<?php echo $lang['username'] ?>">
												</div>
												<div class="form-group">
													<label class="pull-left control-label mb-10" for="exampleInputpwd_2">Password</label>
													<a class="capitalize-font txt-primary block mb-10 pull-right font-12" href="forgot-password.html">forgot password ?</a>
													<div class="clearfix"></div>
													<input type="password" class="form-control" required="" id="exampleInputpwd_2" name="password" placeholder="<?php echo $lang['password'] ?>">
												</div>
												...
												<div class="form-group text-center">
													<button type="submit" class="btn btn-success  btn-rounded" name="submit"  value=""><?php echo $lang['btn_login'] ?></button>
												</div>
											</form>
										</div>
									</div>	
		...
		<!-- jQuery -->
		<script src="<?php echo SITEURL; ?>admin/assets/vendors/bower_components/jquery/dist/jquery.js"></script>
