...
$(document).on('click', '.playVideo', function(e) {
	...
	var title = $(this).html();
    $.post("requests4/index.php?type=playVideo", {
            id: getId
        },
        function(data) {
            $("#loading-screen").hide();
...
$(document).on('click', '.threeDots', function(e) {
    ...
    $.post("requests4/index.php?type=more", {
		id: getId
	},
	function(data) {
		$("#loading-screen").hide();
...
$(document).on('click', '#regBtn', function(e) {
    ...
    $.post("requests4/index.php?type=register", {
            username: username,
            pass: pass,
            rePass: rePass,
            email: email
...
$(document).on('click', '#loginBtn', function(e) {
    ...
    $.post("requests4/index.php?type=login", {
            username: username,
            pass: pass
        },
        function(data) {
...
function bodyLoad() {
    ...
    if ($.cookie('tryq8flix2')) {
		...
		$.post("requests4/index.php?type=home", {
			type: "get",
		},
		function(data) {
			$("#loading-screen").hide();
...
$(document).on('click', '#logoutLabel', function(e) {
    $.post("requests4/index.php?type=logout", {
            type: "remove",
        },
        function(data) {
            if (data == 0) {
...
$(document).on('click', '#forgetBtn', function(e) {
    ...
    $.post("requests4/index.php?type=forget", {
            email: email,
        },
        function(data) {
            if (data == 0) {
...
$(document).on('click', '#profileBtn', function(e) {
    ...
    $.ajax({
        url: 'requests4/index.php?type=profile',
        dataType: 'text',
        cache: false,
        contentType: false,
        processData: false,
...
$(document).on('click', '#conBtn', function(e) {
    ...
    $.post("requests4/index.php?type=contact", {
            title: title,
            msg: msg
        },
        function(data) {
...
$(document).on('click', '#reqBtn', function(e) {
    ...
    $.post("requests4/index.php?type=request", {
            title: title,
            imdb: imdb,
            msg: msg
        },
...
$(document).on('click', '.likedVidoes', function(e) {
    var id = $(this).attr("id");
    $.post("requests4/index.php?type=likedVidoes", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '.disLikedVidoes', function(e) {
    var id = $(this).attr("id");
    $.post("requests4/index.php?type=disLikedVidoes", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '.addToMyList', function(e) {
    var id = $(this).attr("id");
    $.post("requests4/index.php?type=myList", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '#historyLabel', function(e) {
    $.post("requests4/index.php?type=history", {
            type: "get",
        },
        function(data) {
            $("#historyBody").html("");
...
$(document).on('click', '#movieBtn', function(e) {
    ...
    $.post("requests4/index.php?type=home&category=movies", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.loadMoreBtn', function(e) {
    ...
    $.post("requests4/index.php?type=loadMore&collection="+collection, {
            type: "get",
...
$(document).on('click', '.loadMoreSearchBtn', function(e) {
    ...
    $.post("requests4/index.php?type=loadMoreSearch&search="+search, {
            type: "get",
            more: parseInt(numbers)+1,
        }, 
        function(data) {
...
$(document).on('click', '.categoryTitleTv', function(e) {
    ...
    $.post("requests4/index.php?type=home&genre="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.playServer', function(e) {
    ...
    var iframe = document.getElementById('frame');
    iframe.src = "";
    $.post("requests4/index.php?type=getServer", {
            type: "get",
            data: id,
        },
        function(data) {
