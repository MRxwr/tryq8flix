...
if( isset($_GET["link"]) && !empty($_GET["link"]) ){
    ...
    if($useVideoPlayer) {
        ...
        echo "<iframe id='frame' src='{$_GET["link"]}' style='width:100%;height:100vh;border: none;overflow: hidden;' sandbox='allow-forms allow-scripts allow-same-origin allow-presentation' allowFullScreen></iframe>"; 
    }
}else{
