...
function tvdbTvShowsServers($id_info) {
    ...
    return [
        ['name' => 'Server VidKing', 'link' => "https://www.vidking.net/embed/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Vidsrc CC', 'link' => "https://vidsrc.cc/v2/embed/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Vidsrc ME', 'link' => "https://vidsrc.me/embed/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Videasy', 'link' => "https://player.videasy.net/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Vidcore', 'link' => "https://vidcore.net/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Vaplayer', 'link' => "https://vaplayer.ru/embed/tv/{$id}/{$s}/{$e}?autoplay=1", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server ZXC', 'link' => "https://zxcstream.xyz/player/tv/{$id}/{$s}/{$e}?autoplay=true", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date],
        ['name' => 'Server Mapple', 'link' => "https://mapple.uk/watch/tv/{$id}/{$s}/{$e}?autoPlay=true", 'backdrop' => $backdrop, 'overview' => $overview, 'date' => $date]
    ];
} 
?>