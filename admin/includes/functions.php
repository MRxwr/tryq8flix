					...
					<div class='card w-100'>
						<div class='card-body'>
							...
							<div class='row w-100 p-0 m-0'>
								...
								<div class='col-6 p-1'>
									<div data-bs-toggle='modal' data-bs-target='#threeDots' class='btn btn-warning w-100 threeDots' id='{$shows[$i]["href"]}'><i class='bi bi-three-dots nextBtn'></i></div>
								</div>
							</div>
						</div>
					</div>
