...
<html lang="en">
	<head>
		...
		<title>TRYQ8FLiX Admin Panel</title>		
		<!-- Favicon -->
			...
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						...
						<span class="brand-text">TRYQ8FLiX CP</span>
					</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to TRYQ8FLiX CP</h3>
										...
										<div class="form-wrap">
											<form action="includes/logindb.php" method="post">
												<div class="form-group">
													...
													<input type="text" class="form-control" required="" name="username" id="exampleInputEmail_2" placeholder="Enter username">
												</div>
												<div class="form-group">
