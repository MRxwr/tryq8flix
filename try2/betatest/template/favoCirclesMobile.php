...
<div style="text-align: left; font-size: 15px; "><a target="" href="newmovies.php" style="color: white;text-decoration: none;"><b>Favorites</b></a></div>
    <div id="jssor_6" style="position:relative;margin:0 auto;top:0px;left:0px;width:1000px;height:300px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
...
while ($row = $result->fetch_assoc()){
	?>
	<div>
		<a target="" href="category.php?id=<?php echo $row["catid"] ?>"><img data-u="image" src="<?php echo $row["poster"] ?>" style="border-radius: 50%;border-style:solid;border-width:2px;border-color:darkgrey" /></a>
	</div>
	<?php
}
?>
