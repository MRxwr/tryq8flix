...
$(document).on('click', '.loadMoreSearchBtn', function(e) {
    ...
    $.post("requests/index.php?type=loadMoreSearch&search="+search, {
            type: "get",
            more: parseInt(numbers)+1,
        }, 
        function(data) {
...
$(document).on('click', '.categoryTitleTv', function(e) {
    ...
    $.post("requests/index.php?type=home&collection=last_eps&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.categoryTitlePost', function(e) {
    ...
    $.post("requests/index.php?type=home&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.categoryTitleMovie', function(e) {
    ...
    $.post("requests/index.php?type=home&collection=last_films&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
