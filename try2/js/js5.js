...
$(document).on('click', '.playVideo', function(e) {
	...
	var title = $(this).html();
    $.post("requests5/index.php?type=playVideo", {
            id: getId
        },
        function(data) {
            $("#loading-screen").hide();
...
$(document).on('click', '.threeDots', function(e) {
    ...
    $.post("requests5/index.php?type=more", {
		id: getId
	},
	function(data) {
		$("#loading-screen").hide();
...
$(document).on('click', '#regBtn', function(e) {
    ...
    $.post("requests5/index.php?type=register", {
            username: username,
            pass: pass,
            rePass: rePass,
            email: email
...
$(document).on('click', '#loginBtn', function(e) {
    ...
    $.post("requests5/index.php?type=login", {
            username: username,
            pass: pass
        },
        function(data) {
...
function bodyLoad() {
    ...
    if ($.cookie('tryq8flix2') != null) {
		...
		$.post("requests5/index.php?type=home", {
			type: "get",
		},
		function(data) {
			$("#loading-screen").hide();
...
$(document).on('click', '#logoutLabel', function(e) {
    $.post("requests5/index.php?type=logout", {
            type: "remove",
        },
        function(data) {
            if (data == 0) {
...
$(document).on('click', '#forgetBtn', function(e) {
    ...
    $.post("requests5/index.php?type=forget", {
            email: email,
        },
        function(data) {
            if (data == 0) {
...
$(document).on('click', '#profileBtn', function(e) {
    ...
    $.ajax({
        url: 'requests5/index.php?type=profile',
        dataType: 'text',
        cache: false,
        contentType: false,
        processData: false,
...
$(document).on('click', '#conBtn', function(e) {
    ...
    $.post("requests5/index.php?type=contact", {
            title: title,
            msg: msg
        },
        function(data) {
...
$(document).on('click', '#reqBtn', function(e) {
    ...
    $.post("requests5/index.php?type=request", {
            title: title,
            imdb: imdb,
            msg: msg
        },
...
$(document).on('click', '.likedVidoes', function(e) {
    var id = $(this).attr("id");
    $.post("requests5/index.php?type=likedVidoes", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '.disLikedVidoes', function(e) {
    var id = $(this).attr("id");
    $.post("requests5/index.php?type=disLikedVidoes", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '.addToMyList', function(e) {
    var id = $(this).attr("id");
    $.post("requests5/index.php?type=myList", {
            type: "add",
            id: id
        },
        function(data) {
...
$(document).on('click', '#historyLabel', function(e) {
    $.post("requests5/index.php?type=history", {
            type: "get",
        },
        function(data) {
            $("#historyBody").html("");
...
$(document).on('click', '.liveMatch', function(e) {
	$("#loading-screen").show();
	var id = $(this).attr("id");
    $.post("requests5/index.php?type=live&view="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '#newsBtn', function(e) {
	...
	$("#searchBtn").attr("style","color:#5e5e5e");
	$(".bi-search-heart-fill").addClass("bi-search-heart").removeClass("bi-search-heart-fill");
    $.post("requests5/index.php?type=news", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '#liveBtn', function(e) {
	...
	$("#searchBtn").attr("style","color:#5e5e5e");
	$(".bi-search-heart-fill").addClass("bi-search-heart").removeClass("bi-search-heart-fill");
    $.post("requests5/index.php?type=live", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '#tvBtn', function(e) {
    ...
    $.post("requests5/index.php?type=home&collection=last_eps", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '#movieBtn', function(e) {
    ...
    $.post("requests5/index.php?type=home&collection=last_films", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '#animeBtn', function(e) {
    ...
    $.post("requests5/index.php?type=home&collection=last_eps&category=مسلسلات-انمي", {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.loadMoreBtn', function(e) {
    ...
    $.post("requests5/index.php?type=loadMore&collection="+collection, {
            type: "get",
...
$(document).on('click', '.loadMoreSearchBtn', function(e) {
    ...
    $.post("requests5/index.php?type=loadMoreSearch&search="+search, {
            type: "get",
            more: parseInt(numbers)+1,
        }, 
        function(data) {
...
$(document).on('click', '#searchBtn', function(e) {
    ...
    $("#mainBody").html("<div class='p-3' id='searchBar' style='direction:ltr'><div class='input-group'><div class='input-group-prepend'><button class='btn btn-secondary nextBtn' type='button' id='searchButton' style='background-color: #9f8d5c;'>بحث</button></div><input class='form-control nextBtn' id='searchText' placeholder='إدخل كلمة البحث...' style='border-color: #9f8d5c;color: #9f8d5c;'></div></div><div id='searchBody'></div>");
});
...
$(document).on('click', '#searchButton', function(e) {
	...
	$("#loading-screen").show();
    $.post("requests5/index.php?type=search", {
            type: "get",
            search: search
        },
        function(data) {
...
$(document).on('click', '.categoryTitleTv', function(e) {
    ...
    $.post("requests5/index.php?type=home&collection=last_eps&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.categoryTitlePost', function(e) {
    ...
    $.post("requests5/index.php?type=home&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
...
$(document).on('click', '.categoryTitleMovie', function(e) {
    ...
    $.post("requests5/index.php?type=home&collection=last_films&category="+id, {
            type: "get",
        },
        function(data) {
			$("html, body").animate({ scrollTop: 0 }, "slow", function() {
